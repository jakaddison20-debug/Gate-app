...
function logEvent(userId,type,message,stageId=null,context=null){if(!userId)return;supabase.from('app_events').insert({user_id:userId,event_type:type,message,stage_id:stageId?String(stageId):null,context}).then(()=>{}).catch(()=>{});}
